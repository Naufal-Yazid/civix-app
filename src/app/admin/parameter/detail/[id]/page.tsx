    ...
    <div className="space-y-6">
      <div className="space-y-1">
        <nav className="flex items-center space-x-2 text-xs text-[#64748B]">
          ...
          <span className="font-semibold text-[#002045]">Detail Kategori Kompetensi</span>
        </nav>

        <div className="pt-1">
          <h1 className="text-2xl font-bold text-[#002045]">Detail Kategori Kompetensi</h1>
        </div>
      </div>

      <CategoryForm initialData={category} isViewOnly={true} />
    </div>
  );
}
