    ...
    <section className="relative w-full bg-white pt-12 pb-16 sm:pt-20 sm:pb-24 lg:pt-25 lg:pb-30 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* Kolom Kanan: Double Mockup (HANYA TAMPIL DI DESKTOP - `hidden lg:flex`) */}
          <div className="hidden lg:col-span-6 relative w-full lg:flex justify-end items-center">
            <div className="relative w-full aspect-[4/3] flex items-center justify-end">
              ...
              {/* 2. Mockup iPhone (Di Ujung Kanan) */}
