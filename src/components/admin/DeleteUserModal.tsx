...
import { deleteAssessmentResult } from "@/app/admin/pengguna/actions";
...
export default function DeleteUserModal({ id, userName, userCode }: DeleteUserModalProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error(error);
      alert("Gagal menghapus data hasil assessment.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs p-4 animate-in fade-in duration-150">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 text-center space-y-4 shadow-2xl border border-gray-100">
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-bold text-[#002045]">Hapus Hasil Assessment?</h3>
              <p className="text-xs text-[#64748B] leading-relaxed">
                Apakah anda yakin ingin menghapus data hasil assessment untuk{" "}
